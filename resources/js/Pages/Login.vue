                    ...
                    <div class="mt-2 sm:mx-auto sm:w-full sm:max-w-sm">
                        ...
                        <form class="space-y-6" @submit.prevent="handleForm">
                            ...
                            <div>
                                ...
                                <div class="text-sm">
                                    <Link href="/forgot-password" tabindex="4" class="font-semibold text-[#af38f9] hover:text-[#8c2cc7]">Esqueceu a senha?</Link>
                                </div>
                                </div>
                                <div class="mt-2">
                            ...
                            <div>
                                <div class="flex items-center">
                                    ...
                                    class="rounded border-0 p-3 mr-2 ring-1 ring-inset 
                                    ring-gray-300 focus:outline-0 focus:ring-2 focus:ring-inset
                                    focus:ring-[#8c2cc7] text-[#8c2cc7] focus:ring-offset-0">
                                    
                                    <label for="remember" class="block text-sm font-medium font-light leading-6 text-gray-500">
                                        Manter-me logado
                                    </label>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Entrar</button>
                            </div>
                        </form>

                        <p class="mt-10 text-center text-sm text-gray-500">
                        Novo no booqy?
                        <Link href="/register" tabindex="5" class="font-semibold leading-6 text-[#af38f9] hover:text-[#8c2cc7]">Junte-se a nós!</Link>
                        </p>
                    </div>
                </div>
